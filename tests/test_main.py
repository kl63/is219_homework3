"""
This module contains tests for the calculate_and_print function in the main module.
"""
import pytest
...
def test_calculate_and_print(a_string, b_string, operation_string, expected_string, capsys):
    ...
    Parameters:
    - a_string: The first operand as a string.
    - b_string: The second operand as a string.
    - operation_string: The operation to perform as a string.
    - expected_string: The expected output message.
